...
\begin{figure}[t]
    ...
    \caption{Overview of the ETA prediction architecture. A candidate model predicts remaining sailing time from AIS sequences enriched with weather features.}
